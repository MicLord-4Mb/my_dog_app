// ============================================================
// GalleryPage.tsx — DEPRECATED
// ============================================================
// This monolithic page component has been replaced by dedicated
// route-level view components:
//   - BreedDetailView.tsx  → /gallery and /gallery/breed/:id
//   - BreedGrid.tsx        → /gallery/grid
//
// The routing logic now handles view switching via nested routes
// in gallery.route.tsx instead of the isGridMode flag.
// ============================================================
